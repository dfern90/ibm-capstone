...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        values = filtered_df['class'].value_counts().tolist()
...
@app.callback(
    Output('success-payload-scatter-chart', 'figure'),[Input('site-dropdown', 'value'),
...
def update_scatter_chart(entered_site, selected_payload):
    ...
    if entered_site == 'ALL':
        ...
        title = f'Payload vs Class (All Sites)'
        ...
        title = f'Payload vs Class ({entered_site})'
